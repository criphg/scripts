...
pdf(paste0(f_prefix, '_MAsmooth_before_rescaling_dots.pdf'), width=3000, height=3000)
plotSmoothMA(common_count_mat, plotfun=plot)
dev.off()

## If you want to see the MA line that is used:
pdf(paste0(f_prefix, '_MAsmooth_before_rescaling_dots_MAline.pdf'), width=3000, height=3000)
...
pdf(paste0(f_prefix, '_MAsmooth_before_rescaling_all_common.pdf'), width=3000, height=3000)
...
pdf(paste0(f_prefix, '_MAsmooth_before_rescaling_all_dots_MAline.pdf'), width=3000, height=3000)
...
summary(LRT$qv)
pdf(paste0(f_prefix, '_hist_pval.pdf'), width=3000, height=3000)
...
pdf(paste0(f_prefix, '_MAsmooth_after_rescaling_sig.pdf'), width=3000, height=3000)
#plotSmoothMA(normalized_all_count_mat, pvals=LRT$qv$qvalues)
plotSmoothMA(LRT, pvals=LRT$qv$qvalues)
dev.off()

pdf(paste0(f_prefix, '_MAsmooth_after_rescaling_sig_dots.pdf'), width=3000, height=3000)
...
pdf(paste0(f_prefix, '_MAsmooth_merge_before_rescaling_dots_MAline.pdf'), width=3000, height=3000)
...
pdf(paste0(f_prefix, '_MAsmooth_merge_before_rescaling_all.pdf'), width=3000, height=3000)
plotSmoothMA(all_merge_count_mat)
dev.off()

pdf(paste0(f_prefix, '_MAsmooth_merge_before_rescaling_all_common.pdf'), width=3000, height=3000)
plotSmoothMA(all_merge_count_mat, sel = table_merge_MA[,4] == "merged_common_peak")
dev.off()

pdf(paste0(f_prefix, '_MAsmooth_merge_before_rescaling_all_dots_MAline.pdf'), width=3000, height=3000)
...
summary(LRTm$qv)
pdf(paste0(f_prefix, '_hist_pval_merged.pdf'), width=3000, height=3000)
...
pdf(paste0(f_prefix, '_MAsmooth_merge_after_rescaling_sig.pdf'), width=3000, height=3000)
plotSmoothMA(LRTm, pvals=LRTm$qv$qvalues)
dev.off()

pdf(paste0(f_prefix, '_MAsmooth_merge_after_rescaling_sig_dots.pdf'), width=3000, height=3000)
...
pdf('MAplot_before_rescaling.pdf')
...
pdf('MAplot_after_rescaling.pdf')
