...
#AnA <- dba.analyze(AnA)
AnA <- dba.analyze(AnA, method=DBA_EDGER)
...
AnA.DB <- dba.report(AnA, method=DBA_EDGER, bCounts=TRUE, th=0.05)
...
#BPlotN = dba.plotBox(AnA, method=DBA_EDGER)
#dev.off()
