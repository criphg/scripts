...
#  8 > ChIPpeakAnno >: http://bioconductor.org/packages/release/bioc/html/ChIPpeakAnno.html
...
#3 Criar diretório MAnorm e colocar arquivos MAnorm.sh e MAnorm.r (editados) no seu interior com permissão de execução.
#4 Tamanho do fragmento para MAnorm DEFINIDO PARA CADA UMA DAS AMOSTRAS PRESENE NO LOG DO MACS.
...
for i in `cat $2`; do
        ...
        OutName=`echo $Name | awk -F"_" '{print$1"_MERGED_"$4"_"$6"_sort_index"}'`;
...
##FAZER TESTE COM NOME DO GFF COMPLETO E SUBSTITUIR POR Genes.gff se não funcionar.
##!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                Rscript R_ChIP.R ../../${3}/${4} "../../"${5}"/Broad/sample1_uniq_peaks.bed" ${6}"_Broad";
                perl joinData2.pl ../../${3}/${4} ${6}"_Broad.aPeaks" > ${6}"_Broad_aP_join.xls";

                Rscript R_ChIP.R ../../${3}/${4} "../../"${5}"/Broad/sample2_uniq_peaks.bed" ${7}"_Broad";
                perl joinData2.pl ../../${3}/${4} ${7}"_Broad.aPeaks" > ${7}"_Broad_aP_join.xls";
...
echo "Narrow...";
        cd Narrow;
                ...
                Rscript R_ChIP.R ../../${3}/${4} "../../"${5}"/Narrow/sample1_uniq_peaks.bed" ${6}"_Narrow";
                perl joinData2.pl ../../${3}/${4} ${6}"_Narrow.aPeaks" > ${6}"_Narrow_aP_join.xls";

                Rscript R_ChIP.R ../../${3}/${4} "../../"${5}"/Narrow/sample2_uniq_peaks.bed" ${7}"_Narrow";
                perl joinData2.pl ../../${3}/${4} ${7}"_Narrow.aPeaks" > ${7}"_Narrow_aP_join.xls";
