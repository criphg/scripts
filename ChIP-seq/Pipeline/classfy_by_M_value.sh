...
(head -1 MAnorm_result.xls | sed 's/chr/PeakID\tchr/g'; awk -v var1=$2 -v var2=$3 'BEGIN {OFS="\t"} {if($7 <= -var1 && $9 > var2) {sum+=1; $1="S1_Peak"sum"\t"$1; print$0}}'  MAnorm_result.tmp2) > "S2_UNIQ_PEAK.out"
